      ...
      <div className="flex flex-wrap items-center justify-between gap-3 py-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2 bg-gray-50 px-3 py-1 rounded-md border border-gray-300 h-8">
            ...
            />
            <label htmlFor="show-customer-names-is" className="text-xs font-medium text-gray-700 cursor-pointer select-none whitespace-nowrap">
              Show Names
            </label>
          </div>
        </div>
            ...
            filteredRows.map((row, index) => (
              <React.Fragment key={row.lineItemId}>
                ...
                >
                  ...
                  <TableCell className={`op-body-status op-status-is ${getUpdateColor(row.updated)}`}>
