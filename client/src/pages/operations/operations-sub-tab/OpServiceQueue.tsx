      ...
      <div className="flex flex-wrap items-center justify-between gap-3 py-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2 bg-gray-50 px-3 py-1 rounded-md border border-gray-300 h-8">
            ...
            />
            <label htmlFor="show-customer-names-op" className="text-xs font-medium text-gray-700 cursor-pointer select-none whitespace-nowrap">
              Show Names
            </label>
          </div>
        </div>
                ...
                >
                  ...
                  <TableCell className={`op-body-branch ${getUpdateColor(row.updated)}`}>
                    <div className="flex flex-col gap-0.5">
                      ...
                      <small className="text-[11px] font-semibold uppercase tracking-[0.12em] leading-tight text-emerald-600">
                        {row.Location}
                      </small>
                    </div>
                  </TableCell>
